# python experiment_scripts/train_video.py -c configs/config_mfme_blender.txt
# python experiment_scripts/train_video.py -c configs/config_mfme_nikon.txt
...
# python experiment_scripts/render_video.py -c /home/xinhuang/data/NeuCamera_project/trained_models/Sculpture3_202009/config.txt
